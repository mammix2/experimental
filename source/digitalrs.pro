...
android {
    ...
    RESOURCES = digitalrs.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.digitalrs
    BOOST_LIB_SUFFIX=-mt
...
contains(DIGITALRS_NEED_QT_PLUGINS, 1) {
    DEFINES += DIGITALRS_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/digitalrsgui.h \
    src/qt/digitalrsbridge.h \
...
SOURCES += \
    ...
    src/ringsig.cpp  \
    src/core.cpp  \
    src/qt/digitalrsgui.cpp \
    src/qt/digitalrs.cpp \
    src/qt/digitalrsbridge.cpp \
...
macx:ICON = src/qt/res/icons/digitalrs.icns
macx:TARGET = "DigitalRS"
