...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsDigitalRSBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getDigitalRSBalance() const;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 digitalrsBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
