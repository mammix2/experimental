...
var overviewPage = {
    init: function() {
        ...
        this.digitalrsBal = $("#digitalrsBal"),
    ...
    updateBalance: function(balance, digitalrsBal, stake, unconfirmed, immature) {
        if(balance == undefined)
            balance     = this.balance    .data("orig"),
            digitalrsBal   = this.digitalrsBal  .data("orig"),
            ...
            this.digitalrsBal  .data("orig", digitalrsBal),
        ...
        this.formatValue("digitalrsBal",   digitalrsBal);
    ...
    $("#recipients").append((
        ...
        +  '<div id="recipient[count]" class="recipient"> \
            <div class="flex-right"> \
                ...
                <input id="pay_to[count]" class="pay_to input_box" title="The address to send the payment to  (e.g. SXywGBZBowrppUwwNUo1GCRDTibzJi7g2M)" placeholder="Enter a DigitalRS address (e.g. DXywGBZBowrppUwwNUo1GCRDTibzJi7g2M)" maxlength="128" oninput="base58.check(this);" onchange="$(\'#label[count]\').val(bridge.getAddressLabel(this.value));"/> \
            ...
            <div class="flex-left"> \
                ...
                <select id="unit[count]" class="unit button is-inverse has-fixed-icon"  style="margin-left:10px; height:43px; width:100px;" onchange="unit.format(\'#amount[count]\', $(this).val());"> \
                    <option value="0" title="DigitalRS"                    ' + (unit.type == 0 ? "selected" : "") + '>DRS</option> \
                    <option value="1" title="Milli-DigitalRS (1 / 1000)"   ' + (unit.type == 1 ? "selected" : "") + '>mDRS</option> \
                    <option value="2" title="Micro-DigitalRS (1 / 1000000)"' + (unit.type == 2 ? "selected" : "") + '>&micro;DRS</option> \
                    <option value="3" title="DigitalRSshi (1 / 100000000)" ' + (unit.type == 3 ? "selected" : "") + '>DRSshi</option> \
                </select> \
            </div> \
