...
const string strMessageMagic = "DigitalRS Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    if (nVersion == ANON_TXN_VERSION)
    {
        ...
        if (!fTestNet && nBestHeight < 257000)
        {
            printf("CheckTransaction() failed - anon txn in live before block 257000, %s.\n", GetHash().ToString().c_str());
            return false;
        };
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DigitalRS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    };
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
        ...
        || (nNodeMode != NT_FULL && mapBlockThinIndex.empty()))
    {
        ...
        */
        ...
        const char* pszTimestamp = "Sixteen August 2016";
        CTransaction txNew;
        txNew.nTime = 1471365008;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1471365008;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 508728 : 508728;
        ...
        assert(block.hashMerkleRoot == uint256("0x8a506aece3bfc1bc954315a69bf845a263e479311f83dd2ba1b355bb9f565a0c"));
...
unsigned char pchMessageStart[4] = { 0xd1, 0xe9, 0x21, 0xd8 };
