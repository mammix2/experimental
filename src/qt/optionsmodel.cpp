...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::DRS).toInt();
    ...
    fAutoRedeemDigitalRS = settings.value("fAutoRedeemDigitalRS", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemDigitalRS:
            return fAutoRedeemDigitalRS;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemDigitalRS: return "AutoRedeemDigitalRS";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::DRS).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemDigitalRS: {
            fAutoRedeemDigitalRS = value.toBool();
            settings.setValue("fAutoRedeemDigitalRS", fAutoRedeemDigitalRS);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemDigitalRS() { return fAutoRedeemDigitalRS; }
