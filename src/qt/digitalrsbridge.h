#ifndef DIGITALRSBRIDGE_H
#define DIGITALRSBRIDGE_H
...
class DigitalRSBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit DigitalRSBridge(DigitalRSGUI *window, QObject *parent = 0);
    ~DigitalRSBridge();
