...
#ifndef DIGITALRSGUI_H
#define DIGITALRSGUI_H
...
/**
  DigitalRS GUI main class. This class represents the main window of the DigitalRS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DigitalRSGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit DigitalRSGUI(QWidget *parent = 0);
    ~DigitalRSGUI();
