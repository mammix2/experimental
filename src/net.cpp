...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DigitalRS " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"cryptoedge.net", "node1.cryptoedge.net"},
    {"cryptoedge.net", "node2.cryptoedge.net"},
    {"cryptoedge.net", "node3.cryptoedge.net"},
    {"cryptoedge.net", "node4.cryptoedge.net"},
    {"cryptoedge.net", "node5.cryptoedge.net"},
    {"cryptoedge.net", "node6.cryptoedge.net"},
    ...
    {"cryptoedge.net", "node11.cryptoedge.net"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("digitalrs-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("digitalrs-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("digitalrs-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("digitalrs-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DigitalRS is probably already running."), addrBind.ToString().c_str());
        else
